<template>
  <div class="updata-material main container">
    <!-- 上传模型选项卡主体部分 -->
    <div class="pane-body">
      <!-- 上传模型选项卡主体部分--输入框 -->
      ...
      <div class="updata-container">
        ...
        <div class="updata-container-main">
          ...
          <div class="updata-main-left">
            ...
            <button type="button" @click="getToken">获取</button>
            <!-- 测试 -->
            <!-- <div class="model-upload">
              <el-upload
                  class="upload-model"
              ...
              >
                <el-button class="btn-left" slot="trigger" size="small" type="primary">选文件</el-button>
                <el-button class="btn-right" size="small" type="info" @click="submit">上传</el-button>
              </el-upload>
            </div> -->
          </div>
          <!-- 上传模型右 -->
...
import { getToken } from '@/api/ll3d/ll3d.js'
import Vue from 'vue'
import * as api from '@/api/file/file'
import * as modelApi from '@/api/model/model'
...
export default {
  ...
  data() {
    return {
      /*    测试ll3d接口    */
      headers: {
        'Authorization': 'MSMK_FS '
      },
      storeUrl: 'https://store.ll3d.com/fs/model/upload',
      list: [],
      other: {},
      /*    测试ll3d接口    */
  ...
  methods: {
    test(e) {
      ...
      xhr.open('post', 'https://store.ll3d.com/fs/model/upload');
      xhr.setRequestHeader('authorization', that.headers['authorization']);
    ...
    modelUploadSuc(res, file, fileList) {
      ...
      if (res.code === 20000 && res.data !== null) {
        ...
        const data = {
          ...
          this.modelObj.texture=data.mapName// 得到贴图文件
    ...
    uploadModelObj(params) {
      ...
      modelApi.uploadModelObj(params.obj)
          .then(res => {
            if (res.data !== null) {
              params.flag = false
              this.$message({
