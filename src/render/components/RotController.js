        ...
        this.inputRotation = (x, y, z) => {
            if(this.enabledRotate) {
                ...
                if(this.background!=null){
                    // console.log('rotate')
                    // console.log(this.background)
                    this.background.rotateOnWorldAxis(new Vector3(0, 1, 0), -x / 100 * this.rotateSpeed)
                    this.background.rotateOnWorldAxis(new Vector3(1, 0, 0), -y / 100 * this.rotateSpeed)
                    this.background.rotateOnWorldAxis(new Vector3(0, 0, 1), -z)
                }
            }
        }
